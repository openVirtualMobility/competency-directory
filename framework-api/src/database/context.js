export const context = {
  '@context': {
    ...
    label: {
      '@id': 'http://localhost:80/context/referenceType',
      '@type': 'http://schema.org/Text',
    },
    isEssentialPartOf: 'http://localhost:80/context/isEssentialPartOf',
    isOptionalPartOf: 'http://localhost:80/context/isOptionalPartOf',
    needsAsPrerequisite: 'http://localhost:80/context/needsAsPrerequisite',
    isSimilarTo: 'http://localhost:80/context/isSimilarTo',
    isSameAs: 'http://localhost:80/context/isSameAs',
