  ...
  render() {
    return (
      <div style={{
        ...
        <div style={{ width: "80%", alignSelf: "center", height: 2, backgroundColor: "#00abdf" }}></div>
        <div style={{ display: "flex", justifyContent: 'center', alignItems: "center" }}>
          <div style={{ display: "flex", backgroundColor: "reg", width: "50%", margin: 10 }}>
            <Typography>The creation of these resources has been (partially) funded by the ERASMUS+ grant program of the European Union under grant no. 2017-1-DE01-KA203-003494. Neither the European Commission nor the project’s national funding agency DAAD are responsible for the content or liable for any losses or damage resulting of the use of these resources</Typography>
          </div>
          <div style={{
